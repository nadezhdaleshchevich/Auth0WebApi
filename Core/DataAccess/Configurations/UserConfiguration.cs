...
namespace DataAccess.Configurations
{
    internal sealed class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(i => i.Email).HasColumnType("varchar(max)").HasColumnName("user_email").IsRequired();
            builder.Property(i => i.IpAddress).HasColumnType("varchar").HasColumnName("user_id_address").HasMaxLength(30).IsRequired(false);
